...
export interface IBabyStakingInterfaceInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "cake" | "cakePerBlock" | "pendingCake" | "userInfo"
  ): FunctionFragment;
...
export interface IBabyStakingInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBabyStakingInterfaceInterface;
