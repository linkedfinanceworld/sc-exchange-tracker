...
export interface IApeBananaFarmingInterfaceInterface extends utils.Interface {
  functions: {
...
export interface IApeBananaFarmingInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IApeBananaFarmingInterfaceInterface;
