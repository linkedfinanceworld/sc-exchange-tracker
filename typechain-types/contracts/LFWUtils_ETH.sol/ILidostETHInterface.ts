...
export interface ILidostETHInterfaceInterface extends utils.Interface {
  functions: {
...
export interface ILidostETHInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ILidostETHInterfaceInterface;
