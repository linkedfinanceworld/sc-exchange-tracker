...
export interface ISushiswapFarmingInterfaceInterface extends utils.Interface {
  functions: {
...
export interface ISushiswapFarmingInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISushiswapFarmingInterfaceInterface;
