...
export interface ISandboxStakingInterfaceInterface extends utils.Interface {
  functions: {
...
export interface ISandboxStakingInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISandboxStakingInterfaceInterface;
